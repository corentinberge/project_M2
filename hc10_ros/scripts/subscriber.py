...
def callback(data):
    ...
    velocity_float = [float(i) for i in data.velocity]
    # print(efforts_float)
    f.write('{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(
        position_float[0], position_float[1], position_float[2], position_float[3], position_float[4], position_float[5],
        velocity_float[0], velocity_float[1], velocity_float[2], velocity_float[3], velocity_float[4], velocity_float[5],
        efforts_float[0], efforts_float[1], efforts_float[2], efforts_float[3], efforts_float[4], efforts_float[5])
    )
